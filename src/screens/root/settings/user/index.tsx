        ...
        <ScrollView contentContainerStyle={[theme.styles.scroll_container, { paddingVertical: 20 }]} >
            <View style={styles.banner}>
                ...
                <TouchableOpacity
                    ...
                    style={{ position: "absolute", top: 10, right: 10, backgroundColor: theme.colors.default, padding: 10, borderRadius: 10 }}
                >
            ...
            <View style={styles.profileArea}>
                <TouchableOpacity activeOpacity={.7} onPress={() => handlePickImage("profile")}>
                    ...
                    <Ionicons
                        ...
                        name="pencil-outline"
                        style={{ position: "absolute", padding: 5, bottom: 5, right: 5, zIndex: 999, backgroundColor: theme.colors.default, borderRadius: 15 }}
                    />
                </TouchableOpacity>
            </View>
