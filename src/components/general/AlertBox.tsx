            ...
            <View style={styles.messageContainer}>
                <View style={{ width: "20%", justifyContent: "center", padding: 5 }}>
                    <Image source={require("assets/icon.png")} style={{
                        width: 40, height: 40, borderRadius: theme.design.borderRadius 
                    }} />
                </View>
...
const styles = StyleSheet.create({
    ...
    messageContainer: { flexDirection: "row", width: "70%", padding: 5, 
        borderRadius: theme.design.borderRadius, backgroundColor: theme.colors.blue },
